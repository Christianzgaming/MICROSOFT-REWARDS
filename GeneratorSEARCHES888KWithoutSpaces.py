...
# Generate 500,000 random searches with a random letter stuck at the front (no space)
searches_large = []
for _ in range(888_888):
    random_letter = random.choice(letters)
    base = random.choice(base_searches)
    variation = random.choice(variations)
    searches_large.append(f"{random_letter}{base}{variation}".replace(" ", ""))

# Save to file
with open("random_searches_888k.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(searches_large))

print("random_searches_888k.txt has been created successfully!")
